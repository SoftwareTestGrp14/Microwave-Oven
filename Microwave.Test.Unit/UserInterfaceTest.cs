...
namespace Microwave.Test.Unit
{
    ...
    public class UserInterfaceTest
    {
        ...
        public void SetTime_StartButton_CookerIsCalled()
        {
            ...
            cooker.Received(1).StartCooking(7, 60); //Power Rettet fr 50 til 7 da det nu er powerprocent i stedet for powerniveau.
        }
        ...
        public void Ready_PowerAndTime_CookerIsCalledCorrectly()
        {
            ...
            cooker.Received(1).StartCooking(14, 120);//Power Rettet fr 100 til 14 da det nu er powerprocent i stedet for powerniveau.
        }
        ...
        public void Ready_FullPower_CookerIsCalledCorrectly()
        {
            ...
            cooker.Received(1).StartCooking(100, 60); //Power Rettet fr 700 til 100 da det nu er powerprocent i stedet for powerniveau.
